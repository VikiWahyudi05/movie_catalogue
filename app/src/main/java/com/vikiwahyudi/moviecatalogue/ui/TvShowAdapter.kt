package com.vikiwahyudi.moviecatalogue.ui
...
import com.vikiwahyudi.moviecatalogue.databinding.ItemsTvShowBinding
...
class TvShowAdapter : RecyclerView.Adapter<TvShowAdapter.ListViewHolder>() {
    ...
    override fun onCreateViewHolder(
        ...
        ListViewHolder(
            LayoutInflater.from(parent.context).inflate(R.layout.items_tv_show, parent, false)
        )
    ...
    inner class ListViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(data: TvShow) {
            with(binding) {
                ...
                tvItemRelease.text =
                    itemView.resources.getString(R.string.str_release, data.firstAirDate)
